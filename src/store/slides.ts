...
Axios.defaults.baseURL = "/SpringReport-PPTist";
interface postObj{
  url:string
  params:Object
}
...
export const useSlidesStore = defineStore('slides', {
  ...
  actions: {
    ...
    dopost(obj:postObj,headers:object){
      var commonHeader = {
              ...
              .catch(error => {
                  ...
                  if (error && error.response)
                  {
                      switch (error.response.status) {
                          ...
                          case 401:message.error("访问权限不足！");break;
                          case 403:message.error("拒绝访问！");break;
                          case 404:message.error("无法访问，请确认访问地址是否正确");break;
                          case 408:message.error("访问超时。");break;
                          case 500:message.error("系统异常，请联系管理员");break;
                          case 501:message.error("未找到该服务");break;
                          case 502:message.error("网络异常。");break;
                          case 503:message.error("服务器停止运行，请与管理员联系。");break;
                          case 504:message.error("服务器停止运行，请与管理员联系。");break;
                          default:message.error("系统异常！");
                      }
                  }
                  let obj = {
                      code:"50001"
